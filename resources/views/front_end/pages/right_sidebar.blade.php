                ...
                <ul>
                    ...
                    <li class="me">
                        ...
                        <div class="notification-event">
                            ...
                            HI, Rakibul i have faced a problem with your software. are you available now, when i install this i have to received an error.
                        </span>
                    ...
                    <li class="me">
                        <div class="chat-thumb"><img src="{{ asset('frontend/images\resources\paceholder1.jpg') }}" alt=""></div>
                        <div class="notification-event">
                            <span class="chat-message-item">
